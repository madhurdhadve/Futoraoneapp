-- Purpose: Fix for disappearing conversations in the Messaging tab.
-- Category: Utilities
-- Description: This script solves a recursive policy issue in the conversation_participants table that caused infinite loops and empty conversation lists.
