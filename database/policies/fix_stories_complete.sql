-- Purpose: Complete fix for story uploads, including storage bucket and RLS policies.
-- Category: Policies
-- Description: This script handles the end-to-end setup for stories, including bucket creation and both storage and table-level RLS policies.
