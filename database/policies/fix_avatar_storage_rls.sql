-- Purpose: Fix storage RLS policies for avatars and post images.
-- Category: Policies
-- Description: This script ensures that 'post-images' and 'post_images' buckets have correct public read access and authenticated upload/update/delete permissions.
