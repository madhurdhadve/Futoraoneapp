-- Purpose: Fix story Row Level Security (RLS) policies.
-- Category: Policies
-- Description: This script drops existing story policies and recreates them to ensure users can view all stories but only insert or delete their own.
